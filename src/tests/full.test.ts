...
const tests: any = [
  ...
  ...require("../fixtures/Tests/fixtures/smartphone-23.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-24.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-25.json"),
